    ...
    const fetchNotificationSettings = async () => {
        if (isDemoMode) {
            setNotificationConfig({
                smtp: { enabled: true, host: 'smtp.demo.com', port: 587, user: 'user@example.com', password: 'password', encryption: 'ssl' },
                webhook: { enabled: false, webhook_url: 'https://discord.com/api/webhooks/...', webhook_type: 'discord' },
                snmp: { enabled: false, target_host: '10.0.0.10', port: 162, community: 'fs-public' }
            });
            return;
        }

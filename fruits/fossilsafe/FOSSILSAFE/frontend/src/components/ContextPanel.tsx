        ...
        <div className={cn(
            ...
            <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
                ...
                <div className="mb-6 rounded border border-[#27272a] bg-[#09090b] p-4 relative overflow-hidden group">
                    ...
                    {tape.read_only && (
                        <div className="mt-4 rounded border border-amber-500/20 bg-amber-500/10 px-3 py-2 text-[9px] font-mono uppercase tracking-wider text-amber-300">
                            {tape.write_block_reason || 'This tape is configured as read-only legacy media.'}
                        </div>
                    )}
                </div>
                ...
                <div className="mt-8 flex flex-col gap-3">
                    ...
                    {!tape.is_cleaning_tape && !tape.read_only && (
                        <button

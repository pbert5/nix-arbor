...
Start here. The docs are organized as small topic folders; each folder keeps
the local file count low and links deeper when a topic needs room.

## First Stops

| Need | Read |
|---|---|
| repo shape and dendritic architecture | [`architecture/README.md`](./architecture/README.md) |
...
If a folder grows past four docs, split it by workflow or concern instead of
letting it become another flat list.

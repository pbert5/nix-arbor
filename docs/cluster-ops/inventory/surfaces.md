...
- dendrites, fruits, users, normalized networks, and `org.*` policy
...
- named non-leader guest identities
- scoped SSH authorized-key grants
- trusted Yggdrasil guest public keys for private overlay access

This file is for external or non-leader access. Host identities still belong in
`inventory/identity-services/`, and leader root deployer keys still belong in
...
- public/private and intra/inter-LAN layer metadata

...
This lets users select Home Manager pieces through inventory instead of wiring everything by hand.
...
- [`docs/architecture/dendritic-guide.md`](docs/architecture/dendritic-guide.md)
- [`docs/architecture/authoring/authoring-guide.md`](docs/architecture/authoring/authoring-guide.md)
- [`inventory/README.md`](inventory/README.md) for the runnable demo inventory
  (`workstation-1`, `storage-1`)
- [`inventory/complex/README.md`](inventory/complex/README.md) for the more
  involved examples (annex, SeaweedFS, Radicle, tape-backed archive nodes)
